...
#' descriptive statistic that ranges from $-1$ to $+1$. This statistic is also known as the linear 
...
#' statistic that ranges from $0$ to $+1$. The closer to $+1$ the Cramér's \emph{V} is, the stronger the 
#' association between two factor covariates.
#' 
