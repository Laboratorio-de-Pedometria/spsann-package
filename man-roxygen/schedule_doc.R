...
#' The _search graph_ corresponds to the set of effective candidate locations for a sample location selected to
#' be jittered. The size of the search graph, i.e. area within which a sample location can be moved around, is
#' related to the concept of _temperature_. A larger search graph is equivalent to higher temperatures, which
